...
var AudioUpdateModule = function () {
    ...
    _createClass(AudioUpdateModule, [{
        ...
        key: 'renderDate',
        value: function renderDate(text) {
...
var VoiceControls = function () {
	...
	_createClass(VoiceControls, [{
		...
		value: function speak() {
			...
			responsiveVoice.speak(self.audioUpdate.getText(), self.getVoice(), {
